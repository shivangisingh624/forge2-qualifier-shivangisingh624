...
## 🚀 Live Demo
- **Frontend:** https://forge2-qualifier-shivangisingh624.vercel.app/
...
```bash
# Clone repository
git clone https://github.com/shivangisingh624/forge2-qualifier-shivangisingh624
cd forge2-qualifier-shivangisingh624/backend
...
##  Author
Shivangi Singh - Forge 2 Qualifier Participant
